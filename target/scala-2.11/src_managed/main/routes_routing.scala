...
// @LINE:28
private[this] lazy val controllers_PaisController_buscaPorPaginas10_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("paisesPagina/"),DynamicPart("pagina", """[^/]+""",true))))
private[this] lazy val controllers_PaisController_buscaPorPaginas10_invoker = createInvoker(
...
// @LINE:29
private[this] lazy val controllers_PaisController_buscaPorId11_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("paises/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_PaisController_buscaPorId11_invoker = createInvoker(
...
// @LINE:30
private[this] lazy val controllers_PaisController_remover12_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("paises/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_PaisController_remover12_invoker = createInvoker(
...
// @LINE:28
case controllers_PaisController_buscaPorPaginas10_route(params) => {
   call(params.fromPath[Integer]("pagina", None)) { (pagina) =>
        controllers_PaisController_buscaPorPaginas10_invoker.call(controllers.PaisController.buscaPorPaginas(pagina))
   }
}
        

// @LINE:29
case controllers_PaisController_buscaPorId11_route(params) => {
   call(params.fromPath[Integer]("id", None)) { (id) =>
        controllers_PaisController_buscaPorId11_invoker.call(controllers.PaisController.buscaPorId(id))
   }
}
        

// @LINE:30
case controllers_PaisController_remover12_route(params) => {
   call(params.fromPath[Integer]("id", None)) { (id) =>
        controllers_PaisController_remover12_invoker.call(controllers.PaisController.remover(id))
   }
}
